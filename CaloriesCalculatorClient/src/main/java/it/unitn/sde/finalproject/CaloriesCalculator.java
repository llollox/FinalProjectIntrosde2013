...
public interface CaloriesCalculator {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getBMI", targetNamespace = "http://finalproject.sde.unitn.it/", className = "it.unitn.sde.finalproject.GetBMI")
    @ResponseWrapper(localName = "getBMIResponse", targetNamespace = "http://finalproject.sde.unitn.it/", className = "it.unitn.sde.finalproject.GetBMIResponse")
    @Action(input = "http://finalproject.sde.unitn.it/CaloriesCalculator/getBMIRequest", output = "http://finalproject.sde.unitn.it/CaloriesCalculator/getBMIResponse")

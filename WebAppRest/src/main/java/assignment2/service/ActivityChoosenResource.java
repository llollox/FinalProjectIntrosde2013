...
import it.unitn.sde.finalproject.ActivityChoosen;
import it.unitn.sde.finalproject.ActivityChoosenService;
import it.unitn.sde.finalproject.CRUDActivityChoosen;
...
public class ActivityChoosenResource {
	...
	public static CRUDActivityChoosen cactivitychoosen = new ActivityChoosenService().getCRUD();
	...
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Response updateActivityChoosen(@PathParam("id") int id, ActivityChoosen json) {

		ActivityChoosen a = cactivitychoosen.readActivityChoosen(id);

		if (a != null && json.getActivity() != null
				&& json.getDate() != null
				&& json.getGoal() != null
				&& json.getPerson() != null) {

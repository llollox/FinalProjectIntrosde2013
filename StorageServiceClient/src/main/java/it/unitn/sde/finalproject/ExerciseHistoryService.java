    ...
    extends Service
{
    ...
    private final static QName EXERCISEHISTORYSERVICE_QNAME = new QName("http://finalproject.sde.unitn.it/", "ExerciseHistoryService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:5910/lifestyle/storageservice/exercisehistory?wsdl");
    ...
    public ExerciseHistoryService(URL wsdlLocation, WebServiceFeature... features) {
    ...
    public ExerciseHistoryService(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {

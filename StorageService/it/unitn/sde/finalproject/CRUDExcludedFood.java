...
public interface CRUDExcludedFood {
     ...
     * @param arg0
     * @return
     *     returns java.util.List<it.unitn.sde.finalproject.ExcludedFood>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPersonsExcludedFood", targetNamespace = "http://finalproject.sde.unitn.it/", className = "it.unitn.sde.finalproject.GetPersonsExcludedFood")
    @ResponseWrapper(localName = "getPersonsExcludedFoodResponse", targetNamespace = "http://finalproject.sde.unitn.it/", className = "it.unitn.sde.finalproject.GetPersonsExcludedFoodResponse")
    @Action(input = "http://finalproject.sde.unitn.it/CRUDExcludedFood/getPersonsExcludedFoodRequest", output = "http://finalproject.sde.unitn.it/CRUDExcludedFood/getPersonsExcludedFoodResponse")
    public List<ExcludedFood> getPersonsExcludedFood(
        @WebParam(name = "arg0", targetNamespace = "")
        int arg0);

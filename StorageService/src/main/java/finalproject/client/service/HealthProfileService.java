...
public class HealthProfileService extends Service {
	...
	private final static QName HEALTHPROFILESERVICE_QNAME = new QName(
			"http://finalproject.sde.unitn.it/", "HealthProfileService");
	...
	static {
		...
		try {
			url = new URL(
					"http://localhost:5910/lifestyle/storageservice/healthprofile?wsdl");
	...
	/**
	 * 
	 * @return returns CRUDHealthProfile
	 */
	@WebEndpoint(name = "CRUD")
	public HealthProfileWebInterface getCRUD() {
		return super.getPort(new QName("http://finalproject.sde.unitn.it/",
				"CRUD"), HealthProfileWebInterface.class);
	}
	 ...
	 */
	@WebEndpoint(name = "CRUD")
	public HealthProfileWebInterface getCRUD(WebServiceFeature... features) {
		return super.getPort(new QName("http://finalproject.sde.unitn.it/",
				"CRUD"), HealthProfileWebInterface.class, features);
	}
